...
10. media — ảnh tư liệu có nguồn: { "type":"media", "title"?, "sub"?, "image":"đường dẫn", "caption"?:"≤110", "credit"?:"≤80" } — CHỈ dùng khi tư liệu người dùng có sẵn đường dẫn file ảnh; KHÔNG tự bịa đường dẫn
